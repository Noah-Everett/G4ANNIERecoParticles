...
void make_hists( vector< string > files )
{
    ...
    if( present_gammas ){
      ...
      TH2D* hist_primaryPositionVsPhotonThetaNormalized = new TH2D( "", title.c_str(), nBins, min_Primary_X, max_Primary_X, nBins, min_Photon_theta, max_Photon_theta );
      for( int i = 0; i < gammas.size(); i++ ) 
    ...
    if( present_gammas ){
      ...
      TH2D* hist_primaryPositionVsPhotonThetaCNormalized = new TH2D( "", title.c_str(), nBins, min_Primary_X, max_Primary_X, nBins, min_Photon_theta, max_Photon_theta );
      for( int i = 0; i < gammas.size(); i++ ) 
        if( gammas[ i ].CreationProcess == map_process.at( "Cerenkov" ) )
    ...
    if( present_gammas ){
      ...
      TH2D* hist_primaryPositionVsPhotonThetaNotNormalized = new TH2D( "", title.c_str(), nBins, min_Primary_X, max_Primary_X, nBins, min_Photon_theta, max_Photon_theta );
      for( int i = 0; i < gammas.size(); i++ ) 
    ...
    if( present_gammas ){
      ...
      TH2D* hist_primaryPositionVsPhotonNotThetaC = new TH2D( "", title.c_str(), nBins, min_Primary_X, max_Primary_X, nBins, min_Photon_theta, max_Photon_theta );
      for( int i = 0; i < gammas.size(); i++ ) 
        if( gammas[ i ].CreationProcess != map_process.at( "Cerenkov" ) )
    ...
    if( present_gammas ){
      ...
      TH2D* hist_primaryPositionVsPhotonEnergyNormalized = new TH2D( "", title.c_str(), nBins, min_Primary_X, max_Primary_X, nBins, min_Photon_E, max_Photon_E );
      for( int i = 0; i < gammas.size(); i++ ) 
