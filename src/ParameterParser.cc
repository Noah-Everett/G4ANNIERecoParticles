...
void ParameterParser::SetNewValue( G4UIcommand* command, G4String newValue ) {
    if( command == m_parameter_material ) {
        ...
        if( m_parameter_make_tuple_dEdX ) G4cout << "Enabling making dEdX tuple."  << G4endl;
        ...
        if( m_parameter_make_tuple_emission ) G4cout << "Enabling making emission tuple."  << G4endl;
        ...
        if( m_parameter_make_tuple_transmittance ) G4cout << "Enabling making transmittance tuple."  << G4endl;
        ...
        if( m_parameter_make_hist_dEdX ) G4cout << "Enabling making dEdX hist."  << G4endl;
        ...
        if( m_parameter_make_hist_emission ) G4cout << "Enabling making emission hist."  << G4endl;
        ...
        if( m_parameter_make_hist_transmittance ) G4cout << "Enabling making transmittance hist."  << G4endl;
